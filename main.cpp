...
//    }
    ...
    if (ret < 0)
    {
        cout<<"avformat_find_stream_info() failed\n"<<endl;
        return -1;
    }
    ...
    // A3. 查找第一个视频流
//    v_idx = av_find_best_stream(p_fmt_ctx,AVMEDIA_TYPE_VIDEO,0,0,0,0);
//    cout<<p_fmt_ctx->nb_streams<<endl;
    ...
    while (av_read_frame(p_fmt_ctx, p_packet) == 0)
    {
        ...
        {
//            cout<<avcodec_get_name(p_fmt_ctx->streams[v_idx]->codecpar->codec_id)<<endl;
